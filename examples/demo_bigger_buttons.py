...
def drawing_rect():                                     # Function for mapping the clicks of the user in the grid
    numbers = []
    ...
    for l in range(len(top_values)): 
        pg.draw.rect(screen, blue, pg.Rect(top_values[l], left_values[l], 162, 150))
        number = str(numbers[a])
        text = font.render(number, True, white, blue)
        textRect = text.get_rect()
        textRect.center = (top_values[l] + 80, left_values[l] + 74)
...
def main(): 
    ...
    global screen
    screen = pg.display.set_mode((2200, 1100), pg.RESIZABLE) 
    global bck
    ...
    tp.init(screen, tp.theme_text_dark) # *** Binding screen to gui elements and setting the theme ***
    ...
    title0 = "MODE SELECTION"
    message0 = "Choose the mode"
    global choice0
    choice0 = tp.AlertWithChoices(title0, ("AUTO", "MANUAL"), message0, choice_mode="v")
    choice0.set_size((400, 300))
    choice0.set_font_size(50, apply_to_children=True)
    choice0.sort_children(gap=5)
    title = "AUTO MODE"
    message = "What do you \nwant to do?"
    choice1 = tp.AlertWithChoices(title, ("START", "QUIT"), message, choice_mode="v")
    choice1.set_size((400,300))
    choice1.set_font_size(50, apply_to_children=True)
    choice1.sort_children(gap=5)
    text4 = tp.Text("Choose the route for the crane by clicking the grid.")
    text4.set_font_color(font_colour)
    text4.set_font_size(30)
    text5 = tp.Text("MANUAL")
    text5.set_font_size(30)
    text3 = tp.Text("Start the demo by clicking START!")
    text3.set_font_color(font_colour)
    text3.set_font_size(30)
    button3 = tp.Button("START")
    button3.set_font_size(30)
    text8 = tp.Text("Stop the demo by clicking QUIT")
    text8.set_font_color(font_colour)
    text8.set_font_size(30)
    button8 = tp.Button("QUIT")
    button8.set_font_size(30)
    text6 = tp.Text("Change the mode by clicking below")
    text6.set_font_color(font_colour)
    text6.set_font_size(30)
    button6 = tp.Button("CHOOSE MODE")
    button6.set_font_size(30)
    text9 = tp.Text("Erase all checkpoints")
    text9.set_font_color(font_colour)
    text9.set_font_size(30)
    button9 = tp.Button("ERASE")
    button9.set_font_size(30)

    global toggable
    text_toggable = tp.Text("When do you want the \nhook to be lowered?")
    text_toggable.set_font_color(font_colour)
    text_toggable.set_font_size(30)
    ...
    toggable.set_font_size(20, apply_to_children=True)
    ...
    while True: 
        ...
        if choice0.get_value() == "AUTO": 
            ...
            pg.draw.line(screen, line_color, (0, (75*2)), (0, (525*2)), 7)
            pg.draw.line(screen, line_color, (width / 8, (75*2)), (width / 8, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 2, (75*2)),(width / 8 * 2, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 3, (75*2)),(width / 8 * 3, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 4, (75*2)),(width / 8 * 4, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 5, (75*2)),(width / 8 * 5, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 6, (75*2)),(width / 8 * 6, (525*2)), 3)
            pg.draw.line(screen, line_color, (width / 8 * 7, (75*2)),(width / 8 * 7, (525*2)), 3)
            pg.draw.line(screen, line_color, (width, (75*2)), (width, (525*2)), 7)

            # *** drawing horizontal lines for the grid ***
            pg.draw.line(screen, line_color, (0,(75*2)), (width, 150), 7)  
            pg.draw.line(screen, line_color, (0, (75*2) + 150), (width, 75*2 + 150), 3)
            pg.draw.line(screen, line_color, (0, (75*2) + (2*150)),(width, (75*2) + (2*150)), 3)
            pg.draw.line(screen, line_color, (0, (75*2) + (3*150)),(width, (75*2) + (3*150)), 3)
            pg.draw.line(screen, line_color, (0, (75*2) + (4*150)),(width, (75*2) + (4*150)), 3)
            pg.draw.line(screen, line_color, (0, (75*2) + (5*150)),(width, (75*2) + (5*150)), 3)
            pg.draw.line(screen, line_color, (0, (75*2) + (6*150)),(width, (75*2) + (6*150)), 7)
